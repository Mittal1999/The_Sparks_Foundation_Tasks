                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center py-2">Client Name</th>
                                <th scope="col" class="text-center py-2">Client E-Mail</th>
                                <th scope="col" class="text-center py-2">Client Bank Balance</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center"><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn" style="background-color:grey">Transfer Money<i class="material-icons right">attach_money</i></button></a></td>
                                    </tr>
                            <?php
                                }
                            }
