...
<body>
    ...
    <div class="container-fluid">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <input type="number" class="form-control border-black" name="amount" id="amount" required>
            <div class="text-center">
                <button class="btn mt-3" style="background-color: green" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
            <br>
        </form>
    </div>
